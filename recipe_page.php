...
$id = $_GET['id'] ?? null;
$path = "data/recipes/$id/recipe_data.json";

if(!$id || !file_exists($path)) {
    echo "<div class='card'>Recipe not found</div>";
...
<div class="card">
    ...
    <?php 
    $headerPath = "data/recipes/$id/header_image/" . ($data['header_image'] ?? '');
    ...
    if (!empty($data['images'])): ?>
        <div style="margin-top:20px;">
            <?php foreach ($data['images'] as $img): 
                $imgPath = "data/recipes/$id/images/" . $img;
