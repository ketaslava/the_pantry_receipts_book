...
/* ---------- DIRECTORIES ---------- */
$receiptDir      = $baseDir . $id . "/";
$dataFile        = $receiptDir . "receipt_data.json";
$imagesDir       = $receiptDir . "images/";
$headerImageDir  = $receiptDir . "header_image/";
...
<div class="card">
<h2>Edit Receipt #<?= htmlspecialchars($id) ?></h2>
...
<form method="post" enctype="multipart/form-data">
    ...
    <div style="margin-bottom: 50px;">
        ...
        <?php if ($data['header_image'] && file_exists($headerImageDir . $data['header_image'])): ?>
            <div>
                <img src="data/receipts/<?= $id ?>/header_image/<?= $data['header_image'] ?>" 
            ...
            <?php foreach ($data['images'] as $img): ?>
                <?php if(file_exists($imagesDir . $img)): ?>
                    <div style="display:inline-block; margin:5px;">
                        <img src="data/receipts/<?= $id ?>/images/<?= htmlspecialchars($img) ?>" 
                             style="max-width:240px; border-radius:10px;">
                    </div>
                <?php endif; ?>
            <?php endforeach; ?>
    ...
    <button type="submit" name="delete" value="1" class="btn" 
            ...
            onclick="return confirm('Are you sure you want to delete this receipt? This cannot be undone.')">
        Delete Receipt
    </button>
